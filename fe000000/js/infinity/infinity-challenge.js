let InfinityChallenge = {
  goals: [Infinity,
    Decimal.pow(2, 1500), Decimal.pow(2, 10000), Decimal.pow(2, 14336), Decimal.pow(2, 32768),
    Decimal.pow(2, 24576), Decimal.pow(2, 20480), Decimal.pow(2, 22528), Decimal.pow(2, 57344),
  ],
  requirements: [Infinity,
    Decimal.pow(2, 8192), Decimal.pow(2, 13500), Decimal.pow(2, 20768), Decimal.pow(2, 36864),
