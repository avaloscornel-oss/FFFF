let InfinityChallenge = {
  goals: [Infinity,
    Decimal.pow(2, 1500), Decimal.pow(2, 10000), Decimal.pow(2, 14336), Decimal.pow(2, 24768),
    Decimal.pow(2, 34576), Decimal.pow(2, 40960), Decimal.pow(2, 22528), Decimal.pow(2, 57344),
  ],
  ...
  multiplier() {
    return Decimal.pow(2, Math.pow(this.numberOfInfinityChallengesCompleted(),2));
  },
