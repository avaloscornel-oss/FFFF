let STUDY_EFFECTS = [
  ...
  () => Decimal.pow(2, Math.pow(Boost.bought(), 2) / 4096),
  () => Decimal.pow(2, Math.pow(4 * Prestige.prestigePower().log2(), 1) / 4096),
  () => Decimal.pow(2, Math.pow(Math.max(0, Decimal.log2(Eternities.amount())), 2) / 4),
  () => Decimal.pow(2, Math.pow(Studies.totalTheorems(), 2) / 4),
  () => Decimal.pow(new Decimal(Boost.alteredMultiplierPer()),5),
  () => Decimal.pow(Math.max(1, Math.log2(Prestige.prestigePower().log2())), 15),
  () => Decimal.pow(32, Math.pow(Math.log2(
  ...
  x => Decimal.pow(2, 409600 * x),
  x => Decimal.pow(2, x * Math.sqrt(Chroma.totalColorAmount()) * 100),
  x => Decimal.pow(Math.max(Chroma.amount(), 1), x**2),
